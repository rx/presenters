...
var _dialogs = __webpack_require__(40);

var _events = __webpack_require__(35);

window.dialogPolyfill = __webpack_require__(11);
...
(function () {
  ...
  if ("function" === 'function' && 'amd' in __webpack_require__(13)) {
    // AMD support
...
var _loads = __webpack_require__(37);

var _post = __webpack_require__(38);

var _replace = __webpack_require__(39);
...
var VBase = exports.VBase = function () {
    ...
    _createClass(VBase, [{
        ...
        key: 'displayError',
        value: function displayError(content_type, response) {
        ...
        key: 'prependError',
        value: function prependError(div_id, message) {
...
var VPost = exports.VPost = function (_VBase) {
    ...
    _createClass(VPost, [{
        ...
        value: function call() {
            if (!this.httpRequest) {
                new _snackbar.VSnackbar('Cannot talk to server! Please upgrade your browser to one that supports XMLHttpRequest.').display();
                return false;
            }
            this.clearErrors();
            ...
            this.httpRequest.onreadystatechange = function (event) {
                if (_this_.httpRequest.readyState === XMLHttpRequest.DONE) {
                    if (_this_.httpRequest.status >= 200 && _this_.httpRequest.status < 300) {
                        new _snackbar.VSnackbar('Yeah! That worked!').display();
                        console.log(_this_.httpRequest.status + ':' + this.getResponseHeader('content-type') + ':' + event.target.responseText);
                    } else {
                        new _snackbar.VSnackbar('There was a problem with the request.').display();
                        console.log(_this_.httpRequest.status + ':' + this.getResponseHeader('content-type') + ':' + event.target.responseText);
