...
var _dialogs = __webpack_require__(33);

var _textFields = __webpack_require__(34);

var _events = __webpack_require__(49);

var _lists = __webpack_require__(55);

var _iconToggles = __webpack_require__(56);

var _menus = __webpack_require__(70);
...
function initialize() {
    ...
    (0, _textFields.initTextFields)();
    (0, _lists.initLists)();
    (0, _iconToggles.initIconToggles)();
    (0, _menus.initMenus)();
...
var VErrors = exports.VErrors = function () {
    ...
    _createClass(VErrors, [{
        ...
        key: 'prependError',
        value: function prependError(divId, messages, errorsDiv) {
...
window.dialogPolyfill = __webpack_require__(64);
window.componentHandler = __webpack_require__(67);
...
var _index6 = __webpack_require__(48);
...
var _loads = __webpack_require__(50);

var _post = __webpack_require__(51);

var _replace = __webpack_require__(52);

var _dialog = __webpack_require__(53);

var _errors = __webpack_require__(23);

var _toggle_visiblity = __webpack_require__(54);
    ...
    _createClass(VEvents, [{
        ...
        value: function call() {
            ...
            pseries(fnlist).then(function (results) {
                ...
                new _errors.VErrors(event).displayErrors(results);
            });
        }
    }], [{
        key: 'action_class',
...
exports.initIconToggles = initIconToggles;

var _iconToggle = __webpack_require__(57);
...
function initIconToggles() {
    ...
    for (var i = 0; i < components.length; i++) {
        ...
        if (!component.mdcComponent) {
            component.mdcComponent = new _iconToggle.MDCIconToggle(component);
        }
    }
}
...
(function () {
  ...
  if ("function" === 'function' && 'amd' in __webpack_require__(66)) {
    // AMD support
...
function initMenus() {
    ...
    if (components) {
        for (var i = 0; i < components.length; i++) {
            var component = components[i];
            if (!component.mdcComponent) {
                component.mdcComponent = new _menu.MDCMenu(component);
