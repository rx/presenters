require_dependency 'voom/presenters/dsl/components/actions/loads'
require_dependency 'voom/presenters/dsl/components/actions/replaces'
require_dependency 'voom/presenters/dsl/components/actions/posts'
require_dependency 'voom/presenters/dsl/components/actions/updates'
require_dependency 'voom/presenters/dsl/components/actions/deletes'
require_dependency 'voom/presenters/dsl/components/actions/remove'
require_dependency 'voom/presenters/dsl/components/actions/dialog'
require_dependency 'voom/presenters/dsl/components/actions/toggle_visibility'
require_dependency 'voom/presenters/dsl/components/actions/snackbar'
require_dependency 'voom/presenters/dsl/components/actions/clear'
require_dependency 'voom/presenters/dsl/components/actions/navigates'
require_dependency 'voom/presenters/dsl/components/actions/stepper'
